...
<ul>
    <li> Updated the following mods to their latest versions: Mirage (1.25.2), Surfaced (1.5.6), EnemySoundFixes (1.8.0), FairAI (1.5.0), GeneralImprovements (1.4.12), Lategame_Upgrades (3.12.3), LobbyCompatibility (1.5.1), ShipWindows (2.5.1), Haunted_Harpist (1.3.23), MoreCompany (1.11.2), Football (1.1.12), Mimics (2.7.0). </li>
    <li> No mods were removed in this update. </li>
</ul>

### Removed mods [MA]

        AudioKnight-StarlancerMoons, AuronUnicorn-NowhereKingJester, Boniato-Ganimedes, femboytv-LethalPosters, KayNetsua-E_Gypt_Moon, Magic_Wesley-Acidir, Magic_Wesley-Asteroid13, Magic_Wesley-Etern, Magic_Wesley-Fission, Magic_Wesley-Gloom, Magic_Wesley-Gratar, Magic_Wesley-Junic, Magic_Wesley-Oldred, Magic_Wesley-Polarus, Magic_Wesley-WesleysInteriors, Piggy-LC_Office, RosiePies-Gordion_Saga, skelobite-Posters_of_Cats_and_More, Tolian-Tomb, Toybox-LittleCompany

        Inoyu-Giant_Extension_Ladders - Temporarily while issues are getting fixed
...
### Config changes [MI]
        ...
        Configurations updated as needed to support the latest mod versions.

### Updated mods [PA]

        Mirage, Surfaced, EnemySoundFixes, FairAI, Lategame_Upgrades, LobbyCompatibility, ShipWindows, Haunted_Harpist, MoreCompany, Football, Mimics.
...
### Config changes [MI]
        ...
        Updated all configs that needed to reflect the changes within the updated modification/dependencies.
